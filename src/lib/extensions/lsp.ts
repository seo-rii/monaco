...
function createLanguageClient(transports: MessageTransports, language: string): MonacoLanguageClient {
...
export default async function (language: string, url: string) {
